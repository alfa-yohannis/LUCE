...
printf "\nPrepare luce\n"
## Prepare Django
python /luce/luce_django/luce/manage.py migrate

# Load 3 hardcoded users in database
python /luce/luce_django/luce/manage.py loaddata /luce/luce_django/luce/utils/fixtures/demo_users.json
...
# python /luce/luce_django/luce/manage.py loaddata /luce/luce_django/luce/utils/fixtures/demo_all_v2.json

## OR Create users based on GanacheDB
## Create superuser (if no users in init JSON)
# echo "from django.contrib.auth import get_user_model; User = get_user_model(); User.objects.create_superuser('vagrant@luce.com','Vagrant','Luce','Maastricht University','vagrant')" | python /luce/luce_django/luce/manage.py shell
# python /luce/luce_django/luce/manage.py loaddata /luce/luce_django/luce/utils/fixtures/demo_all_v3.json
# python /luce/.config/create_users.py
...
python /luce/luce_django/luce/manage.py runserver 0.0.0.0:8000 --noreload 
